...
public class LGButton: UIView {
    ...
    @IBInspectable public var bgColor: UIColor = MyAppStyle.backgroundColorDefault {
    ...
    @IBInspectable public var titleColor: UIColor = MyAppStyle.textColorDefault {
        didSet{
            setupView()
        }
    }
    ...
    @IBInspectable public var titleFontName: String = MyAppStyle.textFontNameDefault {
        didSet{
            setupView()
        }
    }
    
    @IBInspectable public var titleFontSize: CGFloat = MyAppStyle.textFontSizeDefault {
        didSet{
            setupView()
        }
    }
    ...
    fileprivate func setupView(){
        ...
        // Skip initial call because xibSetup was not called yet
        if bgContentView == nil {
            return
        }
    ...
    fileprivate func xibSetup() {
        ...
        if let lastSubView = self.subviews.last {
            ...
            insertSubview(rootView, belowSubview: lastSubView)
